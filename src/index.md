...
<div style="background: var(--gris-oscuro); border: 1px solid var(--gris-medio); border-radius: 8px; padding: 1.5rem; margin: 2rem 0; font-family: var(--fuente-mono);">
  <div style="display: flex; flex-wrap: wrap; gap: 2rem; align-items: center; margin-bottom: 1rem;">
    ...
    <div>
      ...
      <a href="https://github.com/IA-ismo-Lab" style="color: var(--acento); text-decoration: none; font-weight: bold;">→ Ver repositorios</a>
    </div>
  </div>
</div>
